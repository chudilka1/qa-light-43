package ua.alexyepishev.tests.seleniumTests.driver;
...
import ua.alexyepishev.tests.seleniumTests.driver.DriverType;

import java.net.MalformedURLException;
import java.net.URL;

import static ua.alexyepishev.tests.seleniumTests.driver.DriverType.FIREFOX;
...
public class WebDriverThread {
    ...
    private DriverType determineEffectiveDriverType() {
        ...
        String exampleOfOptionalProperty = TestProperties.BROWSER;
        log.info("OPTIONAL PROPERTY: {}", exampleOfOptionalProperty);
        log.info("Specifying driver (default is '{}')", defaultDriverType);
        try {
            String desiredBrowser = browser.toUpperCase();
            log.info("Desired driver is '{}'", desiredBrowser);
            driverType = DriverType.valueOf(desiredBrowser);
